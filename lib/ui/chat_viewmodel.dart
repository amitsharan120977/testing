import 'package:testing/models/chat.dart';
import 'package:testing/models/chat_message.dart';
import 'package:testing/models/chat_user.dart';
import 'package:testing/utils/app_const.dart';
...
class ChatViewModel {
  ...
  List<ChatWithMembers> generatetestingChats() {
